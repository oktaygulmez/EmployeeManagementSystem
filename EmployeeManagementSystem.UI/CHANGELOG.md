...
- Create Angular project with ng: `ng new employeemanagementsystem.ui --defaults --skip-install --skip-git `.
...
- Create project file (`employeemanagementsystem.ui.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `employeemanagementsystem.ui.esproj`).
